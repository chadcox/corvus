// Generated from WindowsSecurityAuditEvents.xlsx (Security Audit Events sheet).
// Do not edit manually; regenerate from source spreadsheet when updated.
export const SECURITY_AUDIT_EVENT_DESCRIPTIONS: Record<string, string> = {
